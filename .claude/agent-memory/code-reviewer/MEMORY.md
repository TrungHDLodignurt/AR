...
- [sceneview 4.31.0 frame-callback facts](sceneview-frame-callback-facts.md) — main-thread callback, exceptions swallowed, AtomicReference callbacks, dispose closes the Session
